...
bank_marketing = datasets.fetch_openml(name='bank-marketing', as_frame='auto', parser='liac-arff', version=1)
...
def create_data_quality_report(i: int):
    ...
    report.run(
        ...
        current_data=prod_simulation_data[i * batch_size : (i + 1) * batch_size],
    )
    return report
